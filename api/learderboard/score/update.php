    ...
    )
{
    ...
    if($score->name!=null){
        ...
        // check score is at least 0
        if ($score->score == 0 && $data->score <0) {
        
            // set response code - 503 service unavailable
            http_response_code(503);
            echo json_encode(array("message" => "Score cannot be negative"));

        }
        else {

            // add or subtract score
            $score->score = ($score->score + $data->score);
            ...
            if($score->update()){
                ...
                echo json_encode(array("message" => "Score is updated."));
            }
